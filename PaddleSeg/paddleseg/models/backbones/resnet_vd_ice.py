...
__all__ = [
    "IceResNet18_vd", "IceResNet34_vd", "IceResNet50_vd", "IceResNet101_vd", "IceResNet152_vd"
]
...
class IceResNet_vd(nn.Layer):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 data_format='NCHW'):
        super(IceResNet_vd, self).__init__()
...
def IceResNet18_vd(**args):
    model = IceResNet_vd(layers=18, **args)
    return model


def IceResNet34_vd(**args):
    model = IceResNet_vd(layers=34, **args)
    return model


@manager.BACKBONES.add_component
def IceResNet50_vd(**args):
    model = IceResNet_vd(layers=50, **args)
    return model


@manager.BACKBONES.add_component
def IceResNet101_vd(**args):
    model = IceResNet_vd(layers=101, **args)
    return model


def IceResNet152_vd(**args):
    model = IceResNet_vd(layers=152, **args)
    return model


def IceResNet200_vd(**args):
    model = IceResNet_vd(layers=200, **args)
    return model
