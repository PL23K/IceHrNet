...
__all__ = [
    "IceHRNetBackbone_W18_Small_V1", "IceHRNetBackbone_W18_Small_V2", "IceHRNetBackbone_W18", "IceHRNetBackbone_W30",
    "IceHRNetBackbone_W32", "IceHRNetBackbone_W40", "IceHRNetBackbone_W44", "IceHRNetBackbone_W48", "IceHRNetBackbone_W60", "IceHRNetBackbone_W64"
]


class IceHRNetBackbone(nn.Layer):
    """
    ...
    def __init__(self,
                 ...
                 padding_same=True,
                 use_psa=False):
        super(IceHRNetBackbone, self).__init__()
        ...
        self.feat_channels = [64, 64, sum(stage4_num_channels)]
...
def IceHRNetBackbone_W18_Small_V1(**kwargs):
    model = IceHRNetBackbone(
        stage1_num_modules=1,
        stage1_num_blocks=[1],
...
@manager.BACKBONES.add_component
def IceHRNetBackbone_W18_Small_V2(**kwargs):
    model = IceHRNetBackbone(
        stage1_num_modules=1,
        stage1_num_blocks=[2],
        stage1_num_channels=[64],
...
@manager.BACKBONES.add_component
def IceHRNetBackbone_W18(**kwargs):
    model = IceHRNetBackbone(
        stage1_num_modules=1,
        stage1_num_blocks=[4],
        stage1_num_channels=[64],
...
@manager.BACKBONES.add_component
def IceHRNetBackbone_W30(**kwargs):
    model = IceHRNetBackbone(
        stage1_num_modules=1,
        stage1_num_blocks=[4],
        stage1_num_channels=[64],
...
@manager.BACKBONES.add_component
def IceHRNetBackbone_W32(**kwargs):
    model = IceHRNetBackbone(
        stage1_num_modules=1,
        stage1_num_blocks=[4],
        stage1_num_channels=[64],
...
@manager.BACKBONES.add_component
def IceHRNetBackbone_W40(**kwargs):
    model = IceHRNetBackbone(
        stage1_num_modules=1,
        stage1_num_blocks=[4],
        stage1_num_channels=[64],
...
@manager.BACKBONES.add_component
def IceHRNetBackbone_W44(**kwargs):
    model = IceHRNetBackbone(
        stage1_num_modules=1,
        stage1_num_blocks=[4],
        stage1_num_channels=[64],
...
@manager.BACKBONES.add_component
def IceHRNetBackbone_W48(**kwargs):
    model = IceHRNetBackbone(
        stage1_num_modules=1,
        stage1_num_blocks=[4],
        stage1_num_channels=[64],
...
@manager.BACKBONES.add_component
def IceHRNetBackbone_W60(**kwargs):
    model = IceHRNetBackbone(
        stage1_num_modules=1,
        stage1_num_blocks=[4],
        stage1_num_channels=[64],
...
@manager.BACKBONES.add_component
def IceHRNetBackbone_W64(**kwargs):
    model = IceHRNetBackbone(
        stage1_num_modules=1,
        stage1_num_blocks=[4],
        stage1_num_channels=[64],
